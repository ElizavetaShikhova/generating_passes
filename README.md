...
Ок, вы поставили питон, теперь вы уже ~~программист~~ у цели

Готово! GeneratingPasses.exe запускает программу

В самый первый запуск программа скачает некоторые штучки из интернетика для корректной работы программы, соответственно, 
