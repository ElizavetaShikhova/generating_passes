...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.label_12.setGeometry(QtCore.QRect(267, 35, 438, 255))
        font = QtGui.QFont()
        font.setPixelSize(21)
        font.setBold(True)
        self.label_12.setFont(font)
        self.label_12.setObjectName("label_12")
        self.label_12.setText('Выбери, каким файловым менеджером\n              ты хочешь пользоваться')

        self.radioButton_3 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_3.setGeometry(QtCore.QRect(354, 220, 265, 50))
        self.radioButton_3.setFocusPolicy(QtCore.Qt.StrongFocus)
        font.setPixelSize(19)
        font.setBold(False)
        self.radioButton_3.setStyleSheet("color:rgb(51,58,42)")
        self.radioButton_3.setFont(font)
        self.radioButton_3.setObjectName("radioButton_3")
        self.radioButton_3.setText("Стандартный файловый\nменеджер Windows")
        self.radioButton_3.setChecked(True)

        self.radioButton_4 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_4.setGeometry(QtCore.QRect(354, 300, 310, 75))
        self.radioButton_4.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.radioButton_4.setFont(font)
        self.radioButton_4.setStyleSheet("color:rgb(51,58,42)")
        self.radioButton_4.setObjectName("radioButton_4")
        self.radioButton_4.setText("Кастомный файловый менеджер только\nдля выбора папки с фото\n(чтобы видеть файлы в папке)")

        self.radioButton_5 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_5.setGeometry(QtCore.QRect(354, 405, 265, 50))
        self.radioButton_5.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.radioButton_5.setFont(font)
        self.radioButton_5.setStyleSheet("color:rgb(51,58,42)")
        self.radioButton_5.setObjectName("radioButton_5")
        self.radioButton_5.setText("Кастомный файловый\nменеджер для всего")
